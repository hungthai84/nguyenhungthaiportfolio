    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-5 bg-slate-950/70 backdrop-blur-md animate-fade-in">
        <motion.div
          ...
          className="relative w-full max-w-4xl max-h-[90vh] bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl rounded-3xl border border-white/50 dark:border-slate-800/80 shadow-2xl overflow-hidden flex flex-col"
        >
          {/* TOP HEADER */}
          ...
          {/* SEARCH BAR */}
          <div className="p-3 px-4 bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shrink-0 flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-medium text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-400"
              />
              {searchTerm && (
                <button
          ...
          <div className="p-4 sm:p-5 overflow-y-auto flex-1 custom-scrollbar space-y-4">
            ...
            {searchTerm.trim() ? (
                  ...
                  <div className="space-y-2">
                    {searchResults.map(({ question, category }, idx) => (
                      <button
                        ...
                        className="w-full p-3 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-md transition-all text-left flex items-start gap-3 group"
                      >
                        <div
                        ...
                        <MessageSquarePlus className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 shrink-0 mt-1" />
                      </button>
                    ))}
                  </div>
                )}
              ...
              <div className="animate-fade-in">
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl bg-white dark:bg-slate-800 flex items-center justify-center shrink-0 shadow-xs ${activeCategory.color}`}
                  >
                ...
                <div className="space-y-2.5">
                  {activeCategory.questions.map((q, idx) => (
                    <button
                      ...
                      className="w-full p-3.5 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-md transition-all text-left flex items-start gap-3 group"
                    >
          ...
          {/* FOOTER */}
          <div className="p-3.5 px-5 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shrink-0 flex items-center justify-between text-xs text-slate-500">
